...
<html>
	...
	<body>
		<a href="#list-tagType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-tagType" class="content scaffold-list" role="main">
			...
			<thead>
				...
				<g:each in="${tagTypeInstanceList}" status="i" var="tagTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tagTypeInstance.id}">${fieldValue(bean: tagTypeInstance, field: "name")}</g:link></td>
